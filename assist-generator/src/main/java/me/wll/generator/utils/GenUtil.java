 ...
 */
package me.wll.generator.utils;

import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.template.*;
import lombok.extern.slf4j.Slf4j;
import me.wll.common.utils.FileUtil;
import me.wll.common.utils.StringUtils;
import me.wll.generator.model.dto.ColumnInfo;
...
public class GenUtil {
     ...
     * 生成代码
     * 
     * @param columnInfos 列数据
     * @param genConfig 配置数据
     * @throws IOException
     *
     * @变更记录 2023年7月18日 下午3:07:10 武林林 创建
     *
     */
    ...
    private static String getAdminFilePath(String templateName, GenConfig genConfig, String className, String rootPath) {
        ...
        if ("QueryCriteria".equals(templateName)) {
            return packagePath + "model" + File.separator + "dto" + File.separator + className + "QueryCriteria.java";
        }
     ...
     * @throws IOException
     *
     * @变更记录 2023年7月18日 下午3:08:28 武林林 创建
     *
     */
